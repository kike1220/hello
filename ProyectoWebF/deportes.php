...
<head>
  ...
  <title>Noticias de Oaxaca Deportes</title>
  <!-- Bootstrap core CSS -->
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <img src="logo.png" >
    <center>  <a class="navbar-brand" href="#">DEPORTES</a></center>
    </div>
    <div class="container">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
            ...
            <div class="card my-4">
                <div class="card-body">
                  <img src="anuncio5.png" class="img-rounded" alt="Cinque Terre" width="304" height="236">
                </div>
            </div>
